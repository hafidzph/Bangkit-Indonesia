...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 19 Des 2022 pada 18.12
...
(33, 'download (4).jpg', 24, 'Cut Nyak Dien merupakan pahlawan yang lahir di Aceh Besar tahun 1848. Semasa Perang Aceh, dirinya berdiri memimpin pasukan untuk melawan Belanda.\r\n'),
(34, 'download (3).jpg', 24, 'Peto Syarif yang dikenal sebagai Tuanku Imam Bonjol adalah sosok yang lahir di Kampung Tanjung Bunga, Sumatra Barat pada 1772. Di sana, dia adalah seorang ulama dan pimpinan masyarakat.\r\n');
...
(24, 'Hafidz Putra H', 'user01', 'user123'),
(27, 'Hafidz Putra Herlyansyah', 'hafidz1', 'apiiett123');
...
--
ALTER TABLE `artikel`
  ADD CONSTRAINT `artikel_ibfk_1` FOREIGN KEY (`id_kategori`) REFERENCES `kategori` (`id_kategori`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `gallery`
--
ALTER TABLE `gallery`
  ADD CONSTRAINT `gallery_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
